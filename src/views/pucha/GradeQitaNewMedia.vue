...
export default {
  ...
  methods: {
    ...
    getTableData(page) {
      ...
      queryNewMediaByCityIdSiteClassity(this.$store.state.city.city_id, this.$store.state.city.site_classify,
    ...
    // 查看网站测评合格不合格详情页面
    scoreDetail(row) {
      // console.log("网站跳转至评分概览===============>"+JSON.stringify(row))
      // this.$router.push("/site/scoreDetail")
      this.$router.push({
